...
max_containers_per_leaf_vm = 16.0 
max_links_per_spine_vm = 64.0 
...
rack_subnets = list(IPNetwork(public_net).subnet(24))[1:numRacks+1]
for rack_subnet in rack_subnets:
    f1_public_subnet.extend(list(rack_subnet.subnet(28))[:numLeafs])

f1_spine_net= '192.100.0.0/13'
spine_subnets = list(IPNetwork(f1_spine_net).subnet(30))[:numRacks*numSpines]

inter_f1_net = '192.168.0.0/16'

f1_mgmt_net= IPNetwork('172.16.0.0/16')
f1_mgmt_ips= list((f1_mgmt_net).iter_hosts())[1:numRacks*numLeafs*2+numSpines+1]
